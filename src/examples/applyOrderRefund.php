...
function main(){
    ...
    $params->accessToken = "21.440c3126c72c20012d2efd0f6674ebd1.6777077.0153502235.013522-77304507"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->applyRefundMoney = 118; // 文档中对应字段：applyRefundMoney，实际使用时请替换成真实参数
    $params->bizRefundBatchId = ""; // 文档中对应字段：bizRefundBatchId，实际使用时请替换成真实参数
    $params->isSkipAudit = 0; // 文档中对应字段：isSkipAudit，实际使用时请替换成真实参数
    $params->orderId = 1448025184758; // 文档中对应字段：orderId，实际使用时请替换成真实参数
    $params->refundReason = "xxxxx"; // 文档中对应字段：refundReason，实际使用时请替换成真实参数
    $params->refundType = 1; // 文档中对应字段：refundType，实际使用时请替换成真实参数
    $params->tpOrderId = "1267515815254"; // 文档中对应字段：tpOrderId，实际使用时请替换成真实参数
    $params->userId = 1567552; // 文档中对应字段：userId，实际使用时请替换成真实参数
    $params->refundNotifyUrl = "xxxxx"; // 文档中对应字段：refundNotifyUrl，实际使用时请替换成真实参数
    $params->pmAppKey = "WXF0pGOvo1TTGU3qCMMhEjvFBkF0bO0Z"; // 文档中对应字段：pmAppKey，实际使用时请替换成真实参数
