...
function main(){
    ...
    $submitOrderLogisticsRequestDataItemEXTMainOrderExpressVal->ID = "1327473188"; // 文档中对应字段：ID，实际使用时请替换成真实参数
    ...
    $submitOrderLogisticsRequestDataItemVal->BizAPPID = "WXF0pGOvo0TTGU2qCMMhEjvFBkF1bO5Z"; // 文档中对应字段：BizAPPID，实际使用时请替换成真实参数
    ...
    $submitOrderLogisticsRequestDataItemVal->ResourceID = "2108268525382"; // 文档中对应字段：ResourceID，实际使用时请替换成真实参数
    
    $params = new BaiduSmartapp\OpenapiClient\SubmitOrderLogisticsRequest();
    $params->accessToken = "25.582f38845a2378a0c1ad6c830176eb53.7141218.3541678646.301737-06425256"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->openId = "k65HEREQhWhWWB4WYqYT1ITUGX"; // 文档中对应字段：open_id，实际使用时请替换成真实参数
    $params->sceneId = "1045346156112"; // 文档中对应字段：scene_id，实际使用时请替换成真实参数
    $params->sceneType = 2; // 文档中对应字段：scene_type，实际使用时请替换成真实参数
    $params->pmAppKey = "WXF7pGOvo4TTGU5qCMMhEjvFBkF2bO5Z"; // 文档中对应字段：pm_app_key，实际使用时请替换成真实参数
