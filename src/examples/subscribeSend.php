...
function main(){
    ...
    $params->templateId = "80515b580e8336a6b6df22db155a3fb0"; // 文档中对应字段：template_id，实际使用时请替换成真实参数
    $params->touserOpenId = "33GetTsw2nWRMVaYnlswLQ3t4y"; // 文档中对应字段：touser_openId，实际使用时请替换成真实参数
    $params->subscribeId = "xxxxx"; // 文档中对应字段：subscribe_id，实际使用时请替换成真实参数
    $params->data = "{\"keyword5\": {\"value\": \"8584-50-88\"},\"keyword6\": {\"value\": \"kfc\"}}"; // 文档中对应字段：data，实际使用时请替换成真实参数
