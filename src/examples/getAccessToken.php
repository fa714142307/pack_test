...
function main(){
    ...
    $params->clientId = "4fecoAqgCIUtzIyA3FAPgoyrc2oUc37c"; // 文档中对应字段：client_id，实际使用时请替换成真实参数
    $params->clientSecret = "rZ2BcWQPSQxS7jhCwSVVx1gfRdNWn2TO"; // 文档中对应字段：client_secret，实际使用时请替换成真实参数
