...
function main(){
    ...
    $params->accessToken = "22.7fa771ebfa1c362dda5b6a373c11633e.4884700.1528013816.773551-30541400"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->appId = 17376344; // 文档中对应字段：app_id，实际使用时请替换成真实参数
    $params->id = 11546; // 文档中对应字段：id，实际使用时请替换成真实参数
    $params->imageUrl = "https://mbs2.bdstatic.com/searchbox/mappconsole/image/77160638/d60d0657-abf6-8d63-a2c0-df7e5b63304b.png"; // 文档中对应字段：imageUrl，实际使用时请替换成真实参数
    ...
    $params->category2Code = "77583"; // 文档中对应字段：category2Code，实际使用时请替换成真实参数
