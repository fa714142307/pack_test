...
function main(){
    ...
    $params->accessToken = "23.121f31753a7374a1c7ad2c227645eb66.1760604.7688415224.675085-03413404"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->path = "pages/index/index"; // 文档中对应字段：path，实际使用时请替换成真实参数
    $params->width = 574; // 文档中对应字段：width，实际使用时请替换成真实参数
