...
function main(){
    ...
    $createCouponRequestbaseInfodateInfoVal->beginTimestamp = 1714645658; // 文档中对应字段：beginTimestamp，实际使用时请替换成真实参数
    $createCouponRequestbaseInfodateInfoVal->endTimestamp = 1780278362; // 文档中对应字段：endTimestamp，实际使用时请替换成真实参数
    $createCouponRequestbaseInfodateInfoVal->getEndTimestamp = 1141076048; // 文档中对应字段：getEndTimestamp，实际使用时请替换成真实参数
    $createCouponRequestbaseInfodateInfoVal->getStartTimestamp = 1852375644; // 文档中对应字段：getStartTimestamp，实际使用时请替换成真实参数
    ...
    $createCouponRequestbaseInfoVal->color = "B427"; // 文档中对应字段：color，实际使用时请替换成真实参数
    ...
    $createCouponRequestbaseInfoVal->quantity = 170; // 文档中对应字段：quantity，实际使用时请替换成真实参数
    $createCouponRequestbaseInfoVal->title = "自动化创建代金券310-66"; // 文档中对应字段：title，实际使用时请替换成真实参数
    
    $params = new BaiduSmartapp\OpenapiClient\CreateCouponRequest();
    $params->accessToken = "21.838f33060a6235a0c1ad7c245766eb55.1732705.1637814507.525460-27365485"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    ...
    $params->leastCost = 12501; // 文档中对应字段：leastCost，实际使用时请替换成真实参数
    $params->reduceCost = 1874; // 文档中对应字段：reduceCost，实际使用时请替换成真实参数
