...
function main(){
    ...
    $addOrderSubInfoRequestDataItemEXTSubsOrderItemsItemRefundProductItemVal->ID = "152107163770"; // 文档中对应字段：ID，实际使用时请替换成真实参数
    ...
    $addOrderSubInfoRequestDataItemEXTSubsOrderItemsItemRefundVal->Amount = "1724"; // 文档中对应字段：Amount，实际使用时请替换成真实参数
    ...
    $addOrderSubInfoRequestDataItemEXTSubsOrderItemsItemOrderDetailVal->SwanSchema = "baiduboxapp://swan/B3GF1AWvCSr67myIs73uqaoYz4pPCSY7/wjz/bdxd/order-detail/order-detail?orderId=544346157805"; // 文档中对应字段：SwanSchema，实际使用时请替换成真实参数
    ...
    $addOrderSubInfoRequestDataItemVal->BizAPPID = "WXF7pGOvo7TTGU1qCMMhEjvFBkF5bO0Z"; // 文档中对应字段：BizAPPID，实际使用时请替换成真实参数
    ...
    $addOrderSubInfoRequestDataItemVal->ResourceID = "1518851781606"; // 文档中对应字段：ResourceID，实际使用时请替换成真实参数
    
    $params = new BaiduSmartapp\OpenapiClient\AddOrderSubInfoRequest();
    $params->accessToken = "27.351f72054a2264a4c7ad4c577824eb61.6504482.0204471437.602132-73878522"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->openId = "k01HEREQhWhWWB3WYqYT0ITUGX"; // 文档中对应字段：open_id，实际使用时请替换成真实参数
    $params->sceneId = "1041821811138"; // 文档中对应字段：scene_id，实际使用时请替换成真实参数
    $params->sceneType = 2; // 文档中对应字段：scene_type，实际使用时请替换成真实参数
    $params->pmAppKey = "WXF4pGOvo8TTGU8qCMMhEjvFBkF5bO7Z"; // 文档中对应字段：pm_app_key，实际使用时请替换成真实参数
