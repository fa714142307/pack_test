...
function main(){
    ...
    $params->accessToken = "28.6fa275ebfa4c606dda5b6a826c74844e.4147612.6080413681.628664-00381005"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->appId = 12470853; // 文档中对应字段：app_id，实际使用时请替换成真实参数
    $params->imageUrl = "https://mbs0.bdstatic.com/searchbox/mappconsole/image/02144831/d17d8538-abf5-6d25-a1c6-df1e3b00633b.png"; // 文档中对应字段：imageUrl，实际使用时请替换成真实参数
    ...
    $params->category2Code = "75811"; // 文档中对应字段：category2Code，实际使用时请替换成真实参数
