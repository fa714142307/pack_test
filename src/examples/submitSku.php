...
function main(){
    ...
    $submitSkuRequestactivityInfoItemVal->activity_desc = "满05减7"; // 文档中对应字段：activity_desc，实际使用时请替换成真实参数
    ...
    $submitSkuRequestpriceInfoVal->real_price = "250"; // 文档中对应字段：real_price，实际使用时请替换成真实参数
    ...
    $submitSkuRequestBodyVal->path = "/pages/detail/detail?id=728038"; // 文档中对应字段：path，实际使用时请替换成真实参数
    ...
    $submitSkuRequestBodyVal->schema = "{\"hotel_name\":\"北京大酒店\",\"hotel_addr\":\"北京西城区\",\"hotel_score\":\"0.8分\",\"hotel_star\":\"经济型酒店\"}"; // 文档中对应字段：schema，实际使用时请替换成真实参数
    ...
    $params->accessToken = "23.bdc73bb5af4234e35b825f6731b78f12.2517110.7575774753.253866-531371288"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
