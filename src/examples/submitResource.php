...
function main(){
    ...
    $params->accessToken = "24.4fa464ebfa0c684dda3b1a183c18533e.5776701.7685818287.584806-60870852"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->appId = 11577043; // 文档中对应字段：app_id，实际使用时请替换成真实参数
    ...
    $params->images = "[\"https://z6.ax6x.com/7728/10/02/IP6kw1.jpg\"]"; // 文档中对应字段：images，实际使用时请替换成真实参数
    $params->mappSubType = "1328"; // 文档中对应字段：mapp_sub_type，实际使用时请替换成真实参数
    $params->mappType = "1588"; // 文档中对应字段：mapp_type，实际使用时请替换成真实参数
    $params->path = "/pages/detail/detail?id=513671"; // 文档中对应字段：path，实际使用时请替换成真实参数
