...
function main(){
    ...
    $params->accessToken = "24.704f07753a6488a7c0ad1c614654eb80.1101477.1006715670.055213-34868302"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->title = "卡券标题"; // 文档中对应字段：title，实际使用时请替换成真实参数
    $params->appRedirectPath = "/test"; // 文档中对应字段：appRedirectPath，实际使用时请替换成真实参数
    $params->couponId = "8308658146"; // 文档中对应字段：couponId，实际使用时请替换成真实参数
