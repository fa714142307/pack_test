...
function main(){
    ...
    $updateOrderSubStatusRequestDataItemVal->BizAPPID = "WXF4pGOvo0TTGU6qCMMhEjvFBkF8bO7Z"; // 文档中对应字段：BizAPPID，实际使用时请替换成真实参数
    ...
    $updateOrderSubStatusRequestDataItemVal->ResourceID = "1527336778267"; // 文档中对应字段：ResourceID，实际使用时请替换成真实参数
    
    $params = new BaiduSmartapp\OpenapiClient\UpdateOrderSubStatusRequest();
    $params->accessToken = "22.883f17405a8441a3c4ad2c782338eb86.5463522.8753366301.551606-58045478"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->openId = "k16HEREQhWhWWB7WYqYT6ITUGX"; // 文档中对应字段：open_id，实际使用时请替换成真实参数
    $params->sceneId = "1734814747666"; // 文档中对应字段：scene_id，实际使用时请替换成真实参数
    $params->sceneType = 1; // 文档中对应字段：scene_type，实际使用时请替换成真实参数
    $params->pmAppKey = "WXF2pGOvo1TTGU8qCMMhEjvFBkF4bO1Z"; // 文档中对应字段：pm_app_key，实际使用时请替换成真实参数
